...
public class FileUtils 
{
	...
	private static ArrayList<String> convertLineToLearningSetRow(String line)
	{
		...
		String[] stringValues = line.split(outputFileValuesSeparator);
	...
	//scriere in fisier primind ca parametru array de string uri
	protected static void writeStringLearningSetToFile(String fileName, String[][] normalizedSet)
	{
		// first create the byte array to be written
		StringBuilder stringBuilder = new StringBuilder();
		for(int n = 0; n < normalizedSet.length; n++) //for each row
