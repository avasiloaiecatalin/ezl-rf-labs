...
public class DistanceUtilsForW {
	protected static ArrayList<Double> getWRow(ArrayList<Iris> list) {
	...
	protected static ArrayList<Double> getWRowForPlaces(ArrayList<Iris> list) {
	...
	protected static double getFi(ArrayList<Double> wRow, Iris p) {
		double fi = 0.0;
	...
	protected static double getFiForPlace(ArrayList<Double> wRow, Iris p) {
		double fi = 0.0;
		ArrayList<Double> pFeatures = new ArrayList<Double>();
		pFeatures.addAll(p.getFeatures());
		if(wRow.size() != pFeatures.size()){
